...
public class LibraryTester {
	...
	@Test
	public void testMediumLibraryAlreadyCheckedOut() {
		mediumLib.add(9711823193304L, "J.K. Rowling", "Harry Potter");
		mediumLib.checkout(9711823193304L, "Jane Doe", 1, 1, 2008);
		assertFalse(mediumLib.checkout(9711823193304L, "John Doe", 1, 2, 2008));
	}
	
	@Test
	public void testMediumLibraryCheckedOut() {
		mediumLib.add(9711823193304L, "J.K. Rowling", "Harry Potter");
		mediumLib.checkout(9711823193304L, "Jane Doe", 1, 1, 2008);
		mediumLib.checkout(9711823193304L, "John Doe", 1, 2, 2008);
		assertEquals(mediumLib.lookup(9711823193304L), "Jane Doe");
	}
}