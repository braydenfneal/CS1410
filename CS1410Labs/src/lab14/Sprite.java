...
public class Sprite {
	...
	public static boolean isOverlapping(Sprite sprite1, Sprite sprite2) {
	        if ((sprite1.yPosition + sprite1.size < sprite2.yPosition) // See if this rectangle is above other
	                || (sprite1.yPosition > sprite2.yPosition + sprite2.size) // See if this rectangle is below other
	                || (sprite1.xPosition + sprite1.size < sprite2.xPosition) // See if this rectangle is left of other
	                || (sprite1.xPosition > sprite2.xPosition + sprite2.size)) // See if this rectangle is right of other
	            return false;
			// If it is not above or below or left or right of the other, it is colliding.
			return true;
	}
